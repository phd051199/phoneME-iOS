...
- [ ] Add physical-iOS sustained non-render spin throttling for worker loops that execute many quanta without producing a frame, with immediate reset at frame/input/blocking boundaries.
